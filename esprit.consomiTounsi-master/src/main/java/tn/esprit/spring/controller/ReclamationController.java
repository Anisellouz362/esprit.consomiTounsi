...
public class ReclamationController {
	...
	IDeliveryService ds;
	 ...
	 private JavaMailSender javaMailSender;
		...
		private List<Reclamations> list;
		private List<Reclamations> listClient;
		private Reclamations r = new Reclamations();
		...
		public String showAddReclamation(Delivery d1 ){
			r.setDelivery(d1);
			r.setClient(d1.getClient());
			return "/pages/client/saveReclamation.xhtml?faces-redirect=true";
		...
		public List<Reclamations> getListClient() {
			listClient = rs.retrieveAllReclamationsByClient((long) 4);
			return listClient;
		}

		public void setListClient(List<Reclamations> listClient) {
		...
		public String sendMail(){
			...
			return "/pages/admin/listeReclamation.xhtml?faces-redirect=true";
		}
	 
		public String showSendMail(Reclamations r1){
			r = r1;
			m = new Mail();
			m.setTo(r.getClient().getEmail());
			return "/pages/admin/send_mail.xhtml?faces-redirect=true";	
		}
		...
		public String addReclamation(){
			...
			rs.addReclamation(r);
			return "/pages/client/listeReclamation.xhtml?faces-redirect=true";
		}
	 ...
	 public String updateReclamation(Reclamations r1){
		 r = r1;
		return "/pages/client/saveReclamation.xhtml?faces-redirect=true";
	 }
	...
	public List<Reclamations> getList() {
		...
		public void setList(List<Reclamations> list) {
			this.list = list;
		}
		...
		public void setR(Reclamations r) {
			this.r = r;
		}
