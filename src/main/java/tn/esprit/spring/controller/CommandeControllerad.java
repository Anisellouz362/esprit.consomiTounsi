...
@Scope(value = "session")
@Controller(value = "commandeControllerad")

@ELBeanName(value = "commandeControllerad") 
@Join(path = "/Commandeadmin", to = "/Commandeadmin.jsf")
public class CommandeControllerad {
	@Autowired
	CommandeService cs;
...
private Long idcom;
	...
	this.setMontantHT(pan.getMontantHT());
	...
	{
		float total=qnt*montantUN;
		cs.updatecommande(new Commande(idcom,name,prenom,productname,qnt,montantUN,total,paymenttype,commandDate,adresse));
		}
