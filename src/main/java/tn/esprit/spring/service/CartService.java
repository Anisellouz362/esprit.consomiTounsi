...
public class CartService {
	...
	@Transactional
	public String addToCart(Long produitId, Long idUser) {
		// TODO Auto-generated method stub
		Cart cartManagedEntity = new Cart();
	...
	public String enleverProduit(Long cartId, Long produitId, Integer quantiteEnvlever) {
		...
		for (int index = 0; index < employeNb; index++) {
			if (cartManagedEntity.getProduits().get(index).getIdProd() == produitId) {
	...
	// quantité prod dans le panier
		...
		public Integer quantiteProduitPanier(Long idCart, Long idProduit) {
			...
			for (int index = 0; index < size; index++) {
				if (cart.getProduits().get(index).getIdProd() == idProduit) {
...
///////////////////////////////////////////////////////////////////JSF/////////////////////////////////////////////////////////////////////////////////////////
		...
		public List<Product> addProductToCart (Long idProduct,Long idUser){
			//init
			Cart cart = new Cart();
		...
		public String deleteProductFromCart(Long cartId, Long produitId) {
			...
			int size = cart.getProduits().size();
			for (int index = 0; index < size; index++) {
				if (cart.getProduits().get(index).getIdProd() == produitId) {
		...
		public Product searchProductInCart(Long idCart,Long idProduct){
			...
			for (int index = 0; index < employeNb; index++) {
				if (cart.getProduits().get(index).getIdProd() == idProduct) {
