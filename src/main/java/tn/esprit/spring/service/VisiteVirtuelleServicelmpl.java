...
public class VisiteVirtuelleServicelmpl implements VisiteVirtuelleService{
	
	@Autowired
	VisiteVirtuelleRepository VisiteVirtuelleRepo;
	
	private static final Logger L=LogManager.getLogger(VisiteVirtuelleServicelmpl .class);
